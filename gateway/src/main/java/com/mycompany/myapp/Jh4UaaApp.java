...
@EnableZuulProxy
public class Jh4UaaApp {

    private static final Logger log = LoggerFactory.getLogger(Jh4UaaApp.class);

    private final Environment env;

    public Jh4UaaApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(Jh4UaaApp.class);
